...
describe("#findAll", () => {
    test("domain posts are returned", async () => {
            ...
            posts: [
                {
                    ...
                    user: {
                        ...
                        location: "",
                        description: "篤志家、教育者、売れないものかき。チャレンジャー。僧侶。フリーメイソン。ナショナリスト。ギャンブラー。全身癌。ついはい。ちょい役専門役者、医者もできる。",
                        ...
                        profile_image_url: "http://pbs.twimg.com/profile_images/1110426165670363136/2ZyuJzHc_normal.jpg",
                        profile_image_url_https: "https://pbs.twimg.com/profile_images/1110426165670363136/2ZyuJzHc_normal.jpg",
                        profile_banner_url: "https://pbs.twimg.com/profile_banners/362401254/1553733471",
        ...
        expect(await postRepository.findAll()).toEqual([
            new Post(
                1244801547067731968,
                new User(362401254, "katsuyatakasu", "高須克弥", "http://pbs.twimg.com/profile_images/1110426165670363136/2ZyuJzHc_normal.jpg"),
